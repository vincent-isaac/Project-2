...
from automl.utils.generic import get_logger, np_list_arange, param_grid_to_lists
    ...
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestRegressor = (
                automl.internal.cuml_wrappers.get_random_forest_regressor()
            )
...
class MLPRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from automl.internal.tunable import TunableMLPRegressor
...
class VotingRegressorContainer(RegressorContainer):
    def __init__(self, experiment):
        ...
        from automl.internal.tunable import TunableVotingRegressor
