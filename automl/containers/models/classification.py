...
import automl.internal.cuml_wrappers
from automl.containers.models.base_model import (
    ModelContainer,
    leftover_parameters_to_categorical_distributions,
)
from automl.internal.cuml_wrappers import get_svc_classifier
...
class MLPClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from automl.internal.tunable import TunableMLPClassifier
...
class RidgeClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RidgeClassifier = automl.internal.cuml_wrappers.get_ridge_classifier()
        else:
            args = {"random_state": experiment.seed}
    ...
    def __init__(self, experiment):
        ...
        if gpu_imported:
            RandomForestClassifier = (
                automl.internal.cuml_wrappers.get_random_forest_classifier()
            )
...
class VotingClassifierContainer(ClassifierContainer):
    def __init__(self, experiment):
        ...
        from automl.internal.tunable import TunableVotingClassifier
