...
from automl.utils._show_versions import _get_deps_info
from automl.utils.generic import get_all_object_vars_and_properties, variable_return
...
class Pipeline(imblearn.pipeline.Pipeline):
    ...
    def __setstate__(self, state):
        pickle_versions = state.get("_automl_versions", {})
