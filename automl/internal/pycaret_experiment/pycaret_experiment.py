...
from automl.utils.constants import DATAFRAME_LIKE
from automl.utils.generic import LazyExperimentMapping
...
class _PyCaretExperiment:
    ...
    def _check_environment(self) -> None:
        ...
        from automl.utils._show_versions import show_versions
    ...
    def load_model(
        ...
        return automl.internal.persistence.load_model(
    ...
    def get_config(self, variable: Optional[str] = None) -> Any:
        ...
        if any(variable.endswith(attr) for attr in ("train", "test", "dataset")):
            msg = (
                f"Variable: '{variable}' used to return the transformed values in automl. "
                "From automl, this will return the raw values. "
