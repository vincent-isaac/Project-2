...
from automl.utils._dependencies import get_module_version
...
def show_versions(optional: bool = True, logger: Optional[logging.Logger] = None):
    ...
    print_func(f"{prefix}automl required dependencies:")  # noqa: T001
    ...
    if optional:
        print_func(f"{prefix}automl optional dependencies:")  # noqa: T001
